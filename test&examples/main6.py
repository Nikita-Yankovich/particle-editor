...
vortex_config = {
    ...
    'is_sprite': False,
    'figure': 'square', #variations: 'circle', square', ...
    'sprite_picture': 'heart_sprite.png',
...
vortex_config_bg['blending'] = True
vortex_config_bg['is_sprite'] = True


vortex_config_core = vortex_config.copy()
vortex_config_core['start_rgba'] = (0, 255, 200, 255)
#vortex_config_core['end_rgba'] = (0, 50, 100, 0)
vortex_config_core['startSize'] = 6
vortex_config_core['blending'] = True
vortex_config_core['startSpin'] = 720
vortex_config_core['endSpin'] = -360
